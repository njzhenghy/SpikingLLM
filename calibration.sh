...
# --save_spike_dir ./pre_symquantized_spike_models_cal/calibration_T$T/$model_name-$quant_mode-weight_lr-$neuron_lr-train_size-$train_size-epochs-$epochs-batch_size-$batch_size \